  ...
  const candidateProfileSocialHandler = (e) => {
    ...
    try {
      axios.post(apiUrl, socialObj, config).then((res) => {
        setShow(false);
        toast.info("Company Profile Social Contacts Added Successfully ...");
        form.resetFields();
      });
    } catch (error) {
      console.log("Errors", error);
          ...
          >
                        ...
                        <div className="row">
                          <div className="col-lg-6 mt-5">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setCandidateFullName(e.target.value)
                              }
                            />

                            <label htmlFor="phone" className="inputDesign mt-4">
                              Phone No:
                            </label>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setCandidateWebsite(e.target.value)
                              }
                            />
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setCandidateEducationLevel(e.target.value)
                              }
                            >
                              <option value="Matric">Matric</option>
                              <option value="Inter">Inter</option>
                              <option value="Bachelor">Bachelor</option>
                              <option value="Masters/Ph D">Masters/Ph D</option>
                            </select>
                          </div>
                          ...
                          <div className="col-lg-6 mt-5">
                            ...
                            <label htmlFor="email" className="inputDesign mt-4">
                              Email Address:
                            </label>
                            ...
                            <div className="d-flex justify-content-between">
                              <div>
                                ...
                                <select
                                  ...
                                  onChange={(e) =>
                                    setCandidateCurrentSalary(e.target.value)
                                  }
                                >
                                  <option value="40-70">40-70 k</option>
                              ...
                              <div>
                                ...
                                <select
                                  ...
                                  onChange={(e) =>
                                    setCandidateExpectedSalary(e.target.value)
                                  }
                                >
                            ...
                            <label htmlFor="age" className="inputDesign mt-4">
                              Age :
                            </label>
            ...
            >
              ...
              >
                <div className="mx-4">
                  <div className="row">
                    <div className="innerTitle mt-4">Social Networks</div>
            ...
            >
              ...
              >
                <div className="mx-4">
                  <div className="row">
                    <div className="innerTitle mt-4">Contact Information</div>
                    <div className="col my-5">
                      <form onSubmit={candidateProfileContactInfoHandler}>
                        <div className="row">
                          <div className="col-lg-6">
                            <label
                              htmlFor="country"
                          ...
                          <div className="col-lg-6">
                            <label htmlFor="city" className="inputDesign mt-4">
                              City :
                            </label>
                            <input
                              type="text"
