  ...
  return (
    <>
      <div>
        ...
        >
          <span className="d-flex align-items-center px-4">
            <AiOutlineHome style={{ fontSize: "22px", marginRight: "6px" }} />{" "}
            Dashboard
          </span>
        </Link>
      </div>
      ...
      <div className="mt-2">
        ...
        >
          <span className="d-flex align-items-center  px-4">
            <CgBriefcase style={{ fontSize: "22px", marginRight: "6px" }} />{" "}
            Applied Jobs
          </span>
        </Link>
      </div>
      {/* <div className="mt-2">
        ...
        >
          <span className="d-flex align-items-center  px-4">
            <AiOutlineBell style={{ fontSize: "22px", marginRight: "6px" }} />{" "}
            Job Alerts
          </span>
        </Link>
      </div> */}
      {/* <div className="mt-2">
        <Link
          ...
          className={`sideNavLinkDesign ${
            location.pathname === "/candidate/jobs/shortlisted" ? "active" : ""
          }`}
        >
          <span className="d-flex align-items-center  px-4">
            <BsBookmark style={{ fontSize: "22px", marginRight: "6px" }} />{" "}
            Shortlisted Jobs
          </span>
        </Link>
      </div> */}
      {/* <div className="mt-2">
        ...
        >
          <span className="d-flex align-items-center  px-4">
            <BiMessageDetail style={{ fontSize: "22px", marginRight: "6px" }} />{" "}
            Messages
          </span>
        </Link>
      </div> */}
